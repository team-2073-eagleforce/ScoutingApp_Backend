...
def view_team_data_2023(team):
    ...
    for m in matches:
        ...
        team_d.append(m[4])
        print("lsdjf;lsjflkjsdklfj   " + f"{len([x for x in auto_grid[2] if int(x) == 1]) + len([x for x in auto_grid[2] if int(x) == 3])*2 + len([x for x in auto_grid[2] if int(x) == 5]) + len([x for x in auto_grid[2] if int(x) == 6])} - {len([x for x in auto_grid[2] if int(x) == 2]) + len([x for x in auto_grid[2] if int(x) == 5]) + len([x for x in auto_grid[2] if int(x) == 4])*2 + len([x for x in auto_grid[2] if int(x) == 7])}")
        print("aaaaa    " + f"{len([x for x in auto_grid[1] if int(x) == 1]) + len([x for x in auto_grid[1] if int(x) == 3])*2 + len([x for x in auto_grid[1] if int(x) == 5]) + len([x for x in auto_grid[1] if int(x) == 6])} - {len([x for x in auto_grid[1] if int(x) == 2]) + len([x for x in auto_grid[1] if int(x) == 5]) + len([x for x in auto_grid[1] if int(x) == 4])*2 + len([x for x in auto_grid[1] if int(x) == 7])}")
        print("jjjjjjj    " + f"{len([x for x in auto_grid[0] if int(x) == 1]) + len([x for x in auto_grid[0] if int(x) == 3])*2 + len([x for x in auto_grid[0] if int(x) == 5]) + len([x for x in auto_grid[0] if int(x) == 6])} - {len([x for x in auto_grid[0] if int(x) == 2]) + len([x for x in auto_grid[0] if int(x) == 5]) + len([x for x in auto_grid[0] if int(x) == 4])*2 + len([x for x in auto_grid[0] if int(x) == 7])}")
